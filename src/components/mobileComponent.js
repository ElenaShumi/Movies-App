...
export default class MobileComponent extends Component {
  ...
  setRatingColor(num) {
    ...
    else if (num >= 3 && num < 5) return '#E97E00'
    else if (num >= 5 && num < 7) return '#E9D100'
      ...
      <>
        {movieList.map((movie) => (
          <Col key={movie.id} xs={24} md={12}>
            <Card hoverable style={{ height: '245px' }} styles={{ body: { padding: 0, overflow: 'hidden' } }}>
              <Flex vertical justify="space-between" style={{ height: '245px' }}>
                <Flex justify="start">
                  <Image
                    alt={movie.title}
                  ...
                  />
                  <Flex vertical style={{ padding: '4px 13px', width: '70%', flexGrow: '1' }}>
                    <Flex justify="space-between">
                      ...
                      <Title
                        ...
                        style={{
                          ...
                          height: '30px',
                          textAlign: 'center',
                          borderColor: this.setRatingColor(movie.vote_average.toFixed(1)),
                        }}
                      >
                ...
                <Paragraph style={{ padding: '0 10px', flexGrow: '1' }}>
                  {this.truncateOverview(movie.overview)}
                </Paragraph>
                <Rate
                  allowHalf
                  // value={}
                  ...
                  count={10}
                  style={{ fontSize: '20px', textAlign: 'end', padding: '0 10px 10px 0' }}
                />
              </Flex>
            </Card>
          </Col>
